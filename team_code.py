...
def train_challenge_model(data_folder, model_folder, verbose):
    ...
    max_features = 13        # number of features to split at in each node (corresponds to mtry in R)
    min_samples_split = 10   # minimum samples required to split an internal node (corresponds to min.node.size in R)
